                    ...
                    <div className='form-wrap'>
                        <div className="col_1-2 form">
                            <div className="form-component">
                                ...
                                <input type="number" value={valueGive}  onChange={(e) => convert(setValueGive, e,valueGive, setValueGet,  optionGive, optionGet)}  className="form-element form-input" name="have" placeholder='1000' />
                            </div>
                            <div>
                        ...
                        <div className="col_1-2 form content-right">
                            <div className="form-component">
                                ...
                                <input type="number" name="need" value={valueGet} onChange={(e) => convert(setValueGet, e,valueGet, setValueGive,  optionGet, optionGive)} className="form-element form-input" placeholder='1000' />
                            </div>
                            <div>
